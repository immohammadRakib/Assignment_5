        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12 pb-12 border-b border-neutral-200/60 dark:border-slate-800">
          <div className="md:col-span-5 space-y-5">
            ...
            <p className="text-sm text-neutral-500 leading-relaxed max-w-sm dark:text-slate-400">
              Discover a reimagined way of finding your next home. We connect
              premium tenants with verified hosts seamlessly across verified
              real properties.
            </p>
          ...
          <div className="md:col-span-2 space-y-4">
            ...
            <ul className="space-y-2.5 text-sm text-neutral-500 dark:text-slate-400">
              <li>
                <Link
                  href="/"
                  className="hover:text-rose-500 transition-colors flex items-center group dark:hover:text-rose-400"
                >
                  Home{" "}
          ...
          <div className="md:col-span-2 space-y-4">
            ...
            <ul className="space-y-2.5 text-sm text-neutral-500 dark:text-slate-400">
              <li>
                <Link
                  href="/contact"
                  className="hover:text-rose-500 transition-colors dark:hover:text-rose-400"
                >
                  Contact
                </Link>
              </li>
              ...
              <li>
                <span className="cursor-pointer hover:text-rose-500 transition-colors dark:hover:text-rose-400">
                  Privacy Policy
                </span>
              </li>
              <li>
          ...
          <div className="md:col-span-3 space-y-4 bg-white p-5 rounded-2xl border border-neutral-200/60 shadow-sm dark:bg-slate-800/60 dark:border-slate-700/60">
            ...
            <ul className="space-y-3 text-xs text-neutral-500 dark:text-slate-400">
              <li className="flex items-start gap-2.5">
                <MapPin
                  size={15}
                  className="text-rose-500 shrink-0 mt-0.5 dark:text-rose-400"
                />
              ...
              <li className="flex items-center gap-2.5">
                <Phone
                  size={15}
                  className="text-rose-500 shrink-0 dark:text-rose-400"
                />
