...
//                 Let's talk about <br /> your <span className="text-[#FF385C]">Next Place</span>
//               </h1>
//               <p className="text-slate-500 font-medium max-w-md leading-relaxed">
//                 Have questions about a property or our process? We're here to help you find the perfect nest.
//               </p>
//             </motion.div>
...
//                   <input type="text" placeholder="John" className="w-full bg-slate-50 border border-slate-200 rounded-2xl px-5 py-3.5 text-sm focus:ring-2 focus:ring-[#FFC]/20 focus:border-[#FFC] outline-none transition-all" />
//                 </div>
//                 <div className="space-y-1">
//                   <label className="text-xs font-bold text-slate-700 ml-1">Last Name</label>
//                   <input type="text" placeholder="Doe" className="w-full bg-slate-50 border border-slate-200 rounded-2xl px-5 py-3.5 text-sm focus:ring-2 focus:ring-[#FFC]/20 focus:border-[#FFC] outline-none transition-all" />
//                 </div>
//               </div>
//               <div className="space-y-1">
//                 <label className="text-xs font-bold text-slate-700 ml-1">Email</label>
//                 <input type="email" placeholder="john@example.com" className="w-full bg-slate-50 border border-slate-200 rounded-2xl px-5 py-3.5 text-sm focus:ring-2 focus:ring-[#FFC]/20 focus:border-[#FFC] outline-none transition-all" />
//               </div>
//               <div className="space-y-1">
//                 <label className="text-xs font-bold text-slate-700 ml-1">Message</label>
//                 <textarea rows={4} placeholder="What can we help you with?" className="w-full bg-slate-50 border border-slate-200 rounded-2xl px-5 py-3.5 text-sm focus:ring-2 focus:ring-[#FFC]/20 focus:border-[#FFC] outline-none transition-all resize-none" />
//               </div>
//               <button className="w-full py-4 bg-[#FF385C] hover:bg-[#E31C5F] text-white font-black rounded-2xl transition-all active:scale-95 flex items-center justify-center gap-3 shadow-xl shadow-rose-500/20">
...
export default function ContactPage() {
  return (
    // 🎯 মেইন ব্যাকগ্রাউন্ড - ডার্ক মোডে আপনার গ্লোবাল থিমের সাথে ম্যাচ করানো হয়েছে
    <main className="min-h-screen bg-slate-50 pt-32 pb-20 dark:bg-background transition-colors duration-300">
      <div className="container mx-auto px-6 max-w-6xl">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="space-y-10">
            ...
            >
              <h1 className="text-4xl md:text-6xl font-black text-slate-900 leading-tight dark:text-slate-100">
                ...
                <span className="text-[#FF385C] dark:text-rose-400">Next Place</span>
              </h1>
            ...
            <div className="space-y-6">
              {[
                ...
                <motion.div
                  ...
                  className="flex items-center gap-4 group"
                >
                  {/* আইকন বক্স - ডার্ক মোডে গাঢ় চারকোল শেড নিবে */}
          ...
          {/* 🎯 ডান পাশের মেইন ফর্ম কার্ড - ডার্ক মোডে গ্লসি শ্যাড-সিএন কার্ড কালার নিবে */}
          <motion.div
