  ...
  return (
    <section className="relative min-h-[85vh] flex items-center justify-center px-6 overflow-hidden bg-slate-900">
      <div
        ...
        style={{
          backgroundImage: `url('https://www.thespruce.com/thmb/QeB-IPpXBpEnmPAfNQ7xXOxHnVQ=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/Have-it-all-studio-apartment-587e9d153df78c17b6d4f076.jpg')`,
        }}
      />
      ...
      <div className="max-w-4xl mx-auto text-center space-y-6 relative z-10 text-white">
        ...
        >
          Discover curated stays and unique spaces designed for your comfort.
