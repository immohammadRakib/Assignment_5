...
import { 
  UserPlus, LayoutDashboard, FilePlus, CheckCircle2, 
  Search, Eye, CreditCard, Star, ArrowRight, Home, ShieldCheck 
} from "lucide-react";
...
export default function ServicePage() {
  ...
  const landlordSteps = [
    { icon: UserPlus, title: "Quick Onboarding", desc: "Register as a Landlord and set up your profile." },
    { icon: LayoutDashboard, title: "Smart Dashboard", desc: "Manage all your properties from one central hub." },
    { icon: FilePlus, title: "Create Listing", desc: "List your Apartment, Studio, or Store easily." },
    { icon: CheckCircle2, title: "Instant Approval", desc: "Review tenant requests and approve with a click." },
  ];

  const tenantSteps = [
    { icon: Search, title: "Easy Discovery", desc: "Browse thousands of verified properties." },
    { icon: Eye, title: "Virtual Tour", desc: "View detailed photos and facilities." },
    { icon: CreditCard, title: "Secure Payment", desc: "Pay rent via Stripe or SSLCommerz safely." },
    { icon: Star, title: "Rate & Review", desc: "Share your stay experience with the community." },
  ];
      ...
      <div className="container mx-auto px-6 max-w-7xl">
        ...
        <div className="text-center mb-20 space-y-4">
          ...
          <h1 className="text-4xl md:text-6xl font-black text-slate-900 tracking-tight">
            Tailored Experiences for <br /> <span className="text-[#FF385C]">Everyone.</span>
          </h1>
        </div>
        ...
        <div className="mb-32">
          <div className="flex items-center gap-4 mb-12">
            ...
            <h2 className="text-3xl font-black text-slate-900">For Landlords</h2>
          </div>
...
>
  <div className="space-y-4 relative z-10">
    <h2 className="text-3xl md:text-5xl font-black tracking-tight">Ready to get started?</h2>
    <p className="text-slate-400 font-medium">Choose your role and explore the possibilities.</p>
  </div>
