...
export default function ServicePage() {
  ...
  return (
    // 🎯 মেইন ব্যাকগ্রাউন্ড - ডার্ক মোডে আপনার গ্লোবাল থিমের সাথে ব্লেন্ড হবে
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            {landlordSteps.map((step, i) => (
              <motion.div
                ...
                viewport={{ once: false }}
                // 🎯 ল্যান্ডলর্ড কার্ডস - ডার্ক মোডে গাঢ় চারকোল গ্লাস ইফেক্ট এবং হোভারে বর্ডার গ্লো করবে
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            {tenantSteps.map((step, i) => (
              <motion.div
                ...
                viewport={{ once: false }}
                // 🎯 টেন্যান্ট কার্ডস - ডার্ক মোডে সফট রোজ টিন্ট ব্যাকগ্রাউন্ড এবং হোভার শ্যাডো ফিক্সড
