  ...
  const values = [
    {
      ...
      desc: "Every listing and landlord undergoes a rigorous verification process to ensure a safe community",
    },
    {
      icon: Heart,
      title: "Tenant First",
    ...
    <main className="min-h-screen bg-white dark:bg-background transition-colors duration-300">
        ...
        <div className="container mx-auto px-6 relative z-10 text-center space-y-8">
          ...
          >
            ...
            <h1 className="text-4xl md:text-7xl font-black text-slate-900 tracking-tighter leading-tight dark:text-slate-100">
              Reimagining the way <br /> you find your{" "}
              <span className="text-[#FF385C] dark:text-rose-400">Home</span>.
            </h1>
            <p className="mt-8 text-slate-500 text-lg md:text-xl max-w-2xl mx-auto font-medium leading-relaxed dark:text-slate-400">
              RentNest is more than just a listing site. We are a
              community-driven ecosystem designed to bridge the gap between
              premium landlords and verified tenants.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 pt-12 max-w-4xl mx-auto">
            {stats.map((stat, i) => (
              ...
              >
                <p className="text-3xl md:text-4xl font-black text-[#FF385C] dark:text-rose-400">
                  {stat.value}
                </p>
                <p className="text-xs font-bold text-slate-400 uppercase tracking-widest mt-1 dark:text-slate-500">
                  {stat.label}
                </p>
              </motion.div>
            ))}
      ...
      <section className="py-24">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16 space-y-3">
            <h2 className="text-3xl md:text-5xl font-black text-slate-900 tracking-tighter dark:text-slate-100">
              Why Choose Us?
            </h2>
            <p className="text-slate-500 font-medium dark:text-slate-400">
              Built with trust, security, and premium user experience.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            {values.map((value, i) => (
              <motion.div
                ...
                viewport={{ once: true }}
                whileHover={{ y: -10 }}
                className="p-10 rounded-2xl bg-white border border-slate-100 shadow-xl shadow-rose-500/5 text-center space-y-5 transition-all dark:bg-card dark:border-border dark:shadow-rose-950/10"
              >
      ...
      <section className="py-24 bg-slate-50 border-t border-slate-100 dark:bg-slate-900/30 dark:border-slate-800">
        <div className="container mx-auto px-6">
          <motion.div
            ...
            viewport={{ once: true }}
            className="max-w-5xl mx-auto bg-white rounded-2xl p-8 md:p-16 border border-slate-200 shadow-2xl shadow-rose-500/5 flex flex-col md:flex-row items-center gap-12 dark:bg-card dark:border-border"
          >
            ...
            <div className="space-y-6 text-center md:text-left flex-1">
              <div>
                <span className="text-[#FF385C] font-black text-xs uppercase tracking-widest mb-2 block dark:text-rose-400">
                ...
                <p className="mt-4 text-slate-500 font-medium leading-relaxed dark:text-slate-400">
                  Hi, I'm Rakib! A passionate full-stack developer based in
                  Sylhet, Bangladesh. I built RentNest to solve the complexities
                  of modern-day rental management.
                </p>
              </div>
      ...
      <section className="py-24 text-center">
        <div className="container mx-auto px-6 space-y-6">
          ...
          <p className="text-slate-500 font-medium max-w-sm mx-auto dark:text-slate-400">
            Discover your dream nest or list your property with RentNest today.
          </p>
