...
export function PropertyFormDialog({ mode, property }: PropertyFormDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      {/* 🎯 এখানে ফিক্স করা হয়েছে: কন্ডিশনাল রেন্ডারিং বাটনের ভেতরে নিয়ে আসা হয়েছে */}
      {/* 🎯 ফিক্স: asChild রিমুভ করা হয়েছে যাতে প্রো-লেভেল কোনো এরর না আসে */}
      ...
      <DialogContent className="max-w-lg bg-white rounded-xl shadow-xl border-neutral-100">
        ...
        <form action={formAction} className="space-y-4 pt-2">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="space-y-1">
              <Label htmlFor="city" className="text-xs font-semibold text-gray-600">
                City
              </Label>
              <Input
                id="city"
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-1">
              <Label htmlFor="pricePerDay" className="text-xs font-semibold text-gray-600">
                Price Per Day (৳)
              </Label>
              <Input
                id="pricePerDay"
          ...
          <div className="space-y-1">
            <Label htmlFor="images" className="text-xs font-semibold text-gray-600">
