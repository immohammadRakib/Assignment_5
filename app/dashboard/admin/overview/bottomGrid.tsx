    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 pt-2">
      <div className="lg:col-span-2 bg-white border border-slate-100 p-6 rounded-3xl shadow-sm space-y-4">
        <h3 className="text-xs font-black uppercase tracking-wider text-slate-400 flex items-center gap-1.5">
          <Activity className="w-4 h-4 text-slate-400" /> Recent System Audit
          Logs
        </h3>
        ...
        <div className="relative border-l border-slate-100 pl-5 space-y-6 py-2">
          <div className="relative">
            ...
            <p className="text-[11px] text-slate-400 mt-0.5">
              User{" "}
              <span className="text-slate-600 font-medium">Amzad Hossain</span>{" "}
              updated access token status to active.
            </p>
            <span className="text-[10px] text-slate-400 bg-slate-50 px-2 py-0.5 rounded-md mt-1.5 inline-block font-medium">
              10 mins ago
            </span>
          </div>
      ...
      <div className="bg-white border border-slate-100 p-6 rounded-3xl shadow-sm space-y-4 flex flex-col justify-between">
        ...
        <Link
          ...
          className="flex items-center justify-between p-3.5 bg-slate-50 hover:bg-rose-50/40 rounded-2xl border border-slate-100 group transition-all"
        >
        ...
        <Link
          ...
          className="flex items-center justify-between p-3.5 bg-slate-50 hover:bg-amber-50/40 rounded-2xl border border-slate-100 group transition-all"
        >
          <div className="flex items-center gap-3">
