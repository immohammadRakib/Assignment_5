...
import { XCircle, ArrowLeft, ShieldAlert, RefreshCw, HelpCircle, AlertTriangle } from "lucide-react";
...
export default function PaymentCancelPage() {
  ...
  // SSLCommerz গেটওয়ে থেকে আসা ইউনিক ট্রানজেকশন আইডি রিড (ফলব্যাকসহ)
  const transactionId = searchParams.get("tranId") || "CNL-" + Math.floor(100000 + Math.random() * 900000);
  ...
  return (
    <div className="flex-1 flex items-center justify-center p-4 bg-neutral-50/60 min-h-[85vh] select-none font-sans antialiased">
      <div className="w-full max-w-md bg-white border border-neutral-100 rounded-3xl p-6 md:p-8 shadow-2xl shadow-neutral-200/40 text-center relative overflow-hidden group">
        ...
        {/* লাক্সারি সফট অরেঞ্জ/অ্যাম্বার ব্যাকগ্রাউন্ড গ্লো ইফেক্টস */}
        ...
        {/* 🎯 ইন্টারেক্টিভ ডাবল-রিং পালসিং ক্যানসেল অ্যানিমেশন */}
        ...
        <div className="space-y-2">
          <h2 className="text-2xl font-black text-gray-900 tracking-tight">Payment Cancelled</h2>
          <p className="text-xs text-neutral-400 max-w-xs mx-auto font-medium">
            The digital remittance session was manually terminated by the user. No transaction fees or stay bills were processed.
          </p>
        </div>

        {/* 💳 মিনি ট্রানজেকশন ক্যানসেলেশন লগ বক্স */}
        <div className="bg-neutral-50/80 border border-neutral-200/50 p-5 rounded-2xl space-y-3 font-mono text-xs my-6 text-left shadow-inner relative z-10 backdrop-blur-md">
          <div className="flex justify-between items-center border-b border-neutral-200/40 pb-2.5">
            <span className="text-neutral-400 font-bold uppercase tracking-wider text-[10px]">Session Hash</span>
          ...
          <div className="flex justify-between items-center border-b border-neutral-200/40 pb-2.5">
            <span className="text-neutral-400 font-bold uppercase tracking-wider text-[10px]">Termination</span>
            <span className="text-amber-600 font-black tracking-wide uppercase flex items-center gap-1 text-[10px]">
              <AlertTriangle className="w-3.5 h-3.5 text-amber-500 shrink-0 animate-bounce" /> User Terminated
            </span>
          </div>
          <div className="flex justify-between items-center pt-0.5">
            <span className="text-neutral-400 font-bold uppercase tracking-wider text-[10px]">Remittance Status</span>
        ...
        {/* ইন্টারেক্টিভ কাস্টম অ্যাকশন বাটন সেট */}
