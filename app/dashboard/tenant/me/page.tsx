...
//   return (
//     <div className="max-w-3xl mx-auto p-2 space-y-6 select-none dark:bg-slate-900">
//       <div className="border-b border-neutral-100 pb-4 dark:text-white">
//         <h1 className="text-2xl font-black text-gray-900 tracking-tight flex items-center gap-2">
//           <User className="w-6 h-6 text-rose-500 dark:text-white" /> My Profile
//         </h1>
...
export default async function TenantProfilePage() {
  ...
  return (
    // 🎯 মেইন কন্টেইনার - ডার্ক মোডে আপনার থিমের ব্যাকগ্রাউন্ড কালারের সাথে ম্যাচ করানো হয়েছে
    <div className="max-w-3xl mx-auto p-2 space-y-6 select-none dark:bg-background transition-colors duration-300">
      
      {/* হেডার সেকশন - ডার্ক মোডে বর্ডার ও টেক্সট কালার ফিক্সড */}
      ...
      {/* ক্লায়েন্ট প্রোফাইল ডেটা কম্পোনেন্ট */}
      <ProfileViewClient profileData={profileData} userEmail={userEmail} />
      ...
      <div className="flex items-center gap-1.5 text-[10px] text-neutral-400 font-semibold justify-center pt-2 dark:text-slate-500">
        ...
        <span>
          Secured cryptographic identity matrix verified by RentNest security layer [⚠]
        </span>
      </div>
    </div>
  );
