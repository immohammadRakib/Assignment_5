...
export default function Error({
  ...
  useEffect(() => {
    // লগ এরর ব্যাকএন্ডে বা কনসোলে ট্র্যাকিংয়ের জন্য
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[85vh] px-4 bg-white select-none">
      ...
      {/* ⚠️ Animated Floating Error Object */}
      <div className="relative mb-10">
        {/* Syncing Shadow with Float Animation */}
      ...
      {/* Text Content with Big Status Number */}
      <div className="text-center space-y-4 max-w-sm relative">
        {/* 500 Watermark Text in Background */}
      ...
      {/* Embedded CSS for Native Keyframe Animations */}
      <style jsx>{`
        @keyframes float {
